...
/**
 * Created by 21poonkw1 on 18/8/2018.
 */
...
public class ContactProvider extends ContentProvider {
    ...
    private Uri insertContact(Uri uri, ContentValues values) {
        ...
        String name = values.getAsString(Contract.ContactEntry.COLUMN_CONTACT_NAME);
        if (name == null) {
    ...
    private int updateContact(Uri uri, ContentValues values, String selection, String[] selectionArgs) {
        ...
        if (values.containsKey(Contract.ContactEntry.COLUMN_CONTACT_NAME)) {
            String name = values.getAsString(Contract.ContactEntry.COLUMN_CONTACT_NAME);
            if (name == null) {
                throw new IllegalArgumentException("Contact requires a name");
            }
        ...
        if (values.containsKey(Contract.ContactEntry.COLUMN_CONTACT_NUMBER)) {
            Integer number = values.getAsInteger(Contract.ContactEntry.COLUMN_CONTACT_NUMBER);
            if (number == null) {
        ...
        return database.update(Contract.ContactEntry.TABLE_NAME, values, selection, selectionArgs);
    }
    ...
    public int delete(Uri uri, String selection, String[] selectionArgs) {
        ...
        switch (match) {
            case CONTACTS:
                ...
                return database.delete(Contract.ContactEntry.TABLE_NAME, selection, selectionArgs);
            case CONTACT_ID:
